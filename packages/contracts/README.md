...
Shared contracts for the Studio restart.
...
These contracts should stay product-first and deterministic.

Files:
- `contract_index.json`
- `circuit_intent.v1.schema.json`
...
Examples:
- `examples/circuit_intent.blink_led.json`
